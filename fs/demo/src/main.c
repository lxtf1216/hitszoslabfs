...
static void* demo_mount(struct fuse_conn_info * conn_info){
    ...
    int *info_buf = (int *)malloc(12);
    ddriver_ioctl(super.driver_fd, IOC_REQ_DEVICE_IO_SZ, info_buf);
    /* 填充super信息 */
    super.sz_io = *info_buf;
    ddriver_ioctl(super.driver_fd, IOC_REQ_DEVICE_SIZE, info_buf );
    super.sz_disk = *info_buf;
    super.sz_blks = super.sz_disk/(2*super.sz_io); 
    free(info_buf);
    return 0;
}
